...
export default function SignUpPage() {
  ...
  const { signup, loginWithGoogle, loginWithFacebook, loginWithDiscord, loginWithTwitter, loginWithTelegram, isAuthenticated, user } = useAuth();
      ...
      <div className={styles.authCard} style={{ 
        ...
        <p style={{ 
          ...
          {showEmailForm 
            ...
            : 'Welcome! Please select an option to register.'}
        </p>
