...
export default function AdminTopBar() {
  ...
  const adminMenuItems: MenuItem[] = [
    ...
    { name: 'Plans', path: '/admin/subscriptions', description: 'Manage customer recurring plans' },
    ...
    { name: 'Delivery Rates', path: '/admin/content/delivery_rates', description: 'Configure warehouse coordinates and delivery charges' },
    { name: 'Delivery Time Slots', path: '/admin/content/subscription_delivery', description: 'Configure recurring delivery time slots' },
    ...
    { name: 'Delivery Time Off / Cutoff Alert', path: '/admin/content/delivery_time_off', description: 'Configure order warning modals after cutoff times' },
