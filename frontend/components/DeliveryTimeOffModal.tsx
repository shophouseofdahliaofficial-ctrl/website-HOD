...
import styles from './DeliveryTimeOffModal.module.css';
...
export default function DeliveryTimeOffModal({ open, title, description, onProceed, onClose }: Props) {
  if (!open) return null;

  return (
    <div className={styles.overlay} role="dialog" aria-modal="true" aria-labelledby="delivery-time-off-title">
      <div className={styles.card}>
        ...
        <h2 id="delivery-time-off-title" className={styles.title}>
          {title}
        </h2>
