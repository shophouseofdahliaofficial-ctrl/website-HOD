...
export default function PhotoboothLoginModal({ open, onSuccess }: Props) {
  ...
  const modal = (
    <div className={`${styles.overlay} ${styles.overlayActive}`} role="presentation" data-lenis-prevent>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="photobooth-login-title"
      >
        {showLoginForm ? (
          <button
            type="button"
        ...
        <div className={styles.content}>
          ...
          <h2 id="photobooth-login-title" className={styles.title}>
            Just one more step!
          </h2>
          <p className={styles.subtitle}>
            Your polaroid design is saved. Log in to complete your print order.
          </p>
