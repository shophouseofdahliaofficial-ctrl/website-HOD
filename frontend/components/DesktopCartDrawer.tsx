                      ...
                      {items.map((it) => {
                        ...
                        return (
                          <div key={itemKey} className={`${styles.cartItem} ${styles.drawerCartItem}`}>
                            {p?.isCustomizable && (
                              <span className={`${productCardStyles.assuredBadge} ${productCardStyles.customizableBadge} ${styles.itemCustomizableBadge}`}>
                                <svg className={productCardStyles.verifiedIcon} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
