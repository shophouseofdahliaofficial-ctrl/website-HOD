type PbCropIconProps = {
  size?: number;
  className?: string;
};

/** Crop tool icon (stroke uses currentColor for light/dark toolbars). */
export default function PbCropIcon({ size = 16, className }: PbCropIconProps) {
  return (
    <svg
      width={size}
      height={size}
