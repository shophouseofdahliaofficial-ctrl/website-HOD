/**
 * Migration script to create verifications table
 * Run this with: node src/database/run_verifications_migration.js
 */
...
async function runMigration() {
  ...
  try {
    const sqlPath = path.join(__dirname, 'create_verifications_table.sql');
    const sql = fs.readFileSync(sqlPath, 'utf8');
    
    console.log('Running migration: create_verifications_table.sql');
